...
# Google Sheet Info
gs4_deauth()
sheet_id <- "1-IqNx3Pb4GPlmRNYonsTcwzHepOGq-LF87mOkLsnlAs"
...
# Vector for Cast
castaways <- c("Jem", "Ben", "Jess", "Bhanu",
               "Kenzie", "Charlie", "Liz", "Jelinsky",
               "Maria", "Hunter", "Moriah", "Q",
               "Soda", "Randen","Tiffany", "Tevin",
               "Venus","Tim")
